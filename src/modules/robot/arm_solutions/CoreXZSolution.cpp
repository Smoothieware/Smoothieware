...
void CoreXZSolution::cartesian_to_actuator(const float cartesian_mm[], float actuator_mm[] ){
    actuator_mm[ALPHA_STEPPER] = cartesian_mm[X_AXIS] + (this->z_reduction * cartesian_mm[Z_AXIS]);
    actuator_mm[BETA_STEPPER ] = cartesian_mm[X_AXIS] - (this->z_reduction * cartesian_mm[Z_AXIS]);
