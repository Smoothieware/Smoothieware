...
float Block::reverse_pass(float exit_speed)
{
    ...
    if (this->entry_speed != this->max_entry_speed)
    {
        ...
        {
            float max_entry_speed = max_allowable_speed(-Planner::get_acceleration(), exit_speed, this->millimeters);
...
float Block::max_exit_speed()
{
    ...
    float max = max_allowable_speed(-Planner::get_acceleration(), this->entry_speed, this->millimeters);
