...
void Laser::on_module_loaded()
{
    ...
    if (pwm_pin == NULL) {
        THEKERNEL->report_error(false, 18, "%d.%d", dummy_pin->port_number, dummy_pin->pin);     // THEKERNEL->streams->printf("Error: Laser cannot use P%d.%d (P2.0 - P2.5, P1.18, P1.20, P1.21, P1.23, P1.24, P1.26, P3.25, P3.26 only). Laser module disabled.\n", dummy_pin->port_number, dummy_pin->pin);
        delete dummy_pin;
        delete this;
        return;
    }
