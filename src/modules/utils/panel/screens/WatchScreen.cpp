...
void WatchScreen::display_menu_line(uint16_t line)
{
    ...
    switch ( line ) {
		...
		case 2: THEPANEL->lcd->printf("%3d%% %2lu:%02lu:%02lu %3u%% sd", this->current_speed, this->elapsed_time / 3600, this->elapsed_time % 3600 / 60, this->elapsed_time % 60,  this->sd_pcnt_played); break;
