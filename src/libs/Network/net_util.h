...
class Socket : public StreamOutput
{
public:
    // callbacks
    virtual void on_send(void) = 0;
    virtual void on_recv(int) = 0;
    virtual void on_accept(void*) {};

    virtual bool can_send(void) = 0;
    virtual bool can_recv(void) = 0;
    virtual bool can_accept(void) { return false; };
