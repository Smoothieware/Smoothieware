...
Config::Config(){
    ...
    this->config_sources.push_back( new FileConfigSource("/local/config.txt", LOCAL_CONFIGSOURCE_CHECKSUM) );
    this->config_sources.push_back( new FileConfigSource("/sd/config.txt",    SD_CONFIGSOURCE_CHECKSUM   ) );
